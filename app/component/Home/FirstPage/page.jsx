...
export default function PlumberLandingPage({ Select }) {
  ...
  const description =
    "نحن نقدم حلول سباكة متكاملة تشمل إصلاح التسربات، تمديد وتركيب شبكات الغاز والماء، إضافة إلى أنظمة التدفئة المركزية. فريقنا متوفر 24/7، مؤهل وجاهز لخدمتك باحترافية عالية.";
